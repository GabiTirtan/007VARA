 ...
 *    Constructor method
 *
 * \param[in] f_period            sensor reading period
 * \param[in] f_senLeftFront      sensor mounteed on left front part
 * \param[in] f_senMidLeftFront   sensor mounteed on mid left front part
 * \param[in] f_senMidRightFront  sensor mounteed on mid right front part
 * \param[in] f_senRightFront     sensor mounteed on right front part
 * \param[in] f_senLeftBack       sensor mounteed on left back part
 * \param[in] f_senRightBack      sensor mounteed on right back part
 * \param[in] f_motionController  motion controller
 */
...
/** \brief  Serial callback method
  ...
  *
  * \param[in]  obj                 CSafetyStopFunction controller object
