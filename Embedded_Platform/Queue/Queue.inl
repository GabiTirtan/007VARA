 ...
 *
 *  \param[in] f_char    element to be added to the queue
 *  \return    None
 */
template <class T, unsigned int N>
 ...
 *
 *  \param[in] f_char    pointer to element to be added to the queue
 *  \param[in] f_len     number of elements to be added
 *  \return    None
 */
template <class T, unsigned int N>
