 ...
 *  Constructor method
 *
 *  \param[in] f_A   the feedback filter coefficients 
 *  \param[in] f_B   the feedforward filter coefficients
 */
...
/** \brief  Operator
  *
  * \param[in] f_u                 reference to input data
...
/** \brief  Operator
  *
  * \param[in] f_u                 reference to the input data
  * \return                        the filtered output data
  */
template <class T, uint32_t NB>
 ...
 *  Constructor method
 *
 *  \param[in] f_stateTransitionMatrix
 *  \param[in] f_inputMatrix
 *  \param[in] f_measurementMatrix
 */
 ...
 *  \param[in] f_inputMatrix
 *  \param[in] f_measurementMatrix
 *  \param[in] f_directTransferMatrix
 */
template <class T, uint32_t NA, uint32_t NB, uint32_t NC>
filter::lti::mimo::CSSModel<T,NA,NB,NC>::CSSModel(
        const CStateTransitionType& f_stateTransitionMatrix,
...
/** \brief  Operator
  *
  * \param[in] f_inputVector        reference to input vector
 ...
 *  Constructor method
 *
 *  \param[in] f_stateTransitionModel
 *  \param[in] f_controlInput
 *  \param[in] f_observationModel
 *  \param[in] f_covarianceProcessNoise
 *  \param[in] f_observationNoiseCovariance
 */
template <class T, uint32_t NA, uint32_t NB, uint32_t NC>
...
/** \brief  Operator
  *
  * \param[in] f_input              reference to input vector
 ...
 *  Constructor method
 *
 *  \param[in] f_systemModel
 *  \param[in] f_jbMatrices
 *  \param[in] f_Q
 *  \param[in] f_R
 */
template <class T, uint32_t NA, uint32_t NB, uint32_t NC>
...
/** \brief  Update
  *
  * \param[in] f_input          vector input
  * \param[in] f_measurement    vector input
  * \return    None
  */
template <class T, uint32_t NA, uint32_t NB, uint32_t NC>
